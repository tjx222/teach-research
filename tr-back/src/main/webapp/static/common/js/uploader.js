(function( factory ) {
	 ...
	 * 对象定义
	 */
	function MyUploader(jq, option) {
		option['browse_button'] = jq[0];
		option['jq'] = jq;
		var init = {};
		...
		// 继承plupload.Uploader对象
		// plupload.Uploader.call(this, option);
	...
	function registPlugin() {
		$.fn.uploader = function(methodOrOption) {
			...
			if (typeof methodOrOption == 'string') {
				...
				loader = new MyUploader($(this), option);
				$(this).data('uploder', loader);
			}else{
