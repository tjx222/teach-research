...
(function(c) {
	...
	var a = {
		onDialogOpen : function() {
			var d = this.settings;
			this.queueData.errorMsg = "某些文件没有添加进上传队列:";
		...
		onUploadError : function(e, i, h) {
			...
			case SWFUpload.UPLOAD_ERROR.SECURITY_ERROR:
				g = "Security Error";
				break;
			case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:/*alert("The upload limit has been reached ("+h+").")*/
				;
