...
<div class="tabs" style="margin-top: 5px;" currentIndex="0" eventType="click">
	<div class="tabsHeader">
		<div class="tabsHeaderContent">
			<ul>
				<li><a href="javascript:;"  id="jvm_local"><span>后台JVM监控</span></a></li>
				<li><a href="${ctx}jy/back/monitor/jvm/front" class="j-ajax" id="jvm_front"><span>前台JVM监控</span></a></li>
			</ul>
		</div>
	</div>
	<div class="tabsContent" style="height:510px" class="layoutBox">
	<div style="line-height:1.5em;margin:5px;overflow:auto;" layoutH="20">
<%
