...
<div class="pageContent">
	...
	<form method="post" id="add_sch_role" action="${ctx }/jy/back/yhgl/saveSchUserSpace" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDoneSch);">
