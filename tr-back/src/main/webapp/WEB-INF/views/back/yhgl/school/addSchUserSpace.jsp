...
<div class="pageContent">
	<form method="post" id="add_sch_role_info" action="${ctx }/jy/back/yhgl/saveSchUserSpace" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDoneSch);">
			...
			$.ajax({
				...
				success:function(data){
					if(data instanceof Array){
						...
						$.each(data,function(index,obj){
							bookStr += '<option value="'+obj.comId+'">'+obj.comName+(obj.bookEdtion ? obj.bookEdtion:'')+(obj.fascicule?obj.fascicule:'')+'</option>';
						});
