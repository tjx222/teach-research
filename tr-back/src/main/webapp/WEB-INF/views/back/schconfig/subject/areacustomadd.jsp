...
<div class="pageContent">
	<form method="post" id="sch_save" action="${ctx }jy/back/schconfig/subject/area/custom/save" class="pageForm required-validate" onsubmit="return subjectFormAdd(this);">
...
function subjectFormAdd(form) {
	...
	$.ajax({
		type:"post",
		async : false, 
		url:"${pageContext.request.contextPath}/jy/back/dic/exists?areaId=${areaId}&parentId=97",
		data:{'name':name},
		dataType:"json",
		cache: false,
