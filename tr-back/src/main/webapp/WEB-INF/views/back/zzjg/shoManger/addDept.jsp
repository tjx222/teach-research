...
<div class="pageContent">
	<form method="post" id="dept_add" action="${ctx }jy/back/zzjg/saveDept" class="pageForm required-validate" onsubmit="return schDeptFormAdd(this);">
