...
<div  id="deptBox">
		<div class="pageHeader" style="border:1px #B8D0D6 solid;width:800px">
			<form id="pagerForm" action="${pageContext.request.contextPath}/jy/back/zzjg/deptInfoFind?parentId=${parentId}" method="post" onsubmit="return dialogSearch(this, ad_xx_dept);">
			<div class="searchBar">
		...
		<div class="pageContent">	
				<div class="panelBar">
					<ul class="toolBar">
						<li><a target="dialog" href="${pageContext.request.contextPath}/jy/back/zzjg/addDept?parentId=${parentId}" class="add"  rel="add_sch"  mask="true"><span>新建部门</span></a></li>
								...
								<c:forEach items="${orgList}" var="data" >
									<tr target="dept_obj" rel="${data.id}" data-id="${data.id}">
							             ...
							             <td>
											 ...
											 <a title="修改"  target="dialog" href="${pageContext.request.contextPath}/jy/back/zzjg/editDept?id=${data.id}&parentId=${parentId}" class="btn_Edit"  rel="edit_sch" mask="true"></a>
...
// 		var serchUnit = $("[name='serchUnit']").val();
		$.pdialog.reload(_WEB_CONTEXT_+"/jy/back/zzjg/deptInfoFind", {data:{parentId:"${parentId}",serchUnit:'${serchUnit }'}, dialogId:"ad_sch_dept", callback:null})
	}
	</script>