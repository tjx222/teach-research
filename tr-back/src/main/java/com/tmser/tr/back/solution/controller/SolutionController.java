 ...
 * 
 * @author 川子
 * @version $Id: SolutionController.java, v 1.0 2015年9月18日 下午3:37:17 川子 Exp $
 */
@Controller
...
public class SolutionController extends AbstractController {
	...
	public List<Organization> getSolutionScope(Organization or, Model m) {
		...
		or.setId(null);
		or.buildCondition(" and id in (select s.orgId from SysOrgSolution s where s.solutionId = :solutionId and s.isDelete = :isDelete)").put("solutionId", sid).put("isDelete", false);
