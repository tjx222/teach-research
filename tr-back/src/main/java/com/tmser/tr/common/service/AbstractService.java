 ...
 */
public abstract class AbstractService<E extends QueryObject, K extends Serializable> extends ListenableSupport
    implements BaseService<E, K>, Listenable {
  ...
  public int update(E model) {
    ...
    fireListenableEvent(Listenable.AFTER_UPDATE_EVENT, model);
    return rs;
  }
  ...
  public void delete(K id) {
    E e = findOne(id);
    fireListenableEvent(Listenable.BEFORE_DELETE_EVENT, e);
    getDAO().delete(id);
    fireListenableEvent(Listenable.AFTER_DELETE_EVENT, e);
  }
  ...
  @Override
  public void batchSave(List<E> models) {
    fireListenableEvent(Listenable.BEFORE_BATCH_INSERT_EVENT, models);
    getDAO().batchInsert(models);
  }
