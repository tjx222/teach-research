...
<body>
<div class="opinions_comment_content" style="height:29rem;">
	<div class="look_opinion_list1" id="look_opinion_list" style="height:22rem;overflow: hidden;">
		<div id="scroller">
			...
			<form  name="pageForm" method="post">
				<ui:page url="${ctx}jy/check/infoIndexM?resId=${model.resId }&flags=${model.flags }&resType=${model.resType }" data="${data}" dataType="true" callback="addmoredatas"/>
				<input type="hidden" class="currentPage" name="page.currentPage">
			</form> 
			<div style="width:100%;height:1.5rem;"></div>
		</div>
	</div>
	<div class="my_publish" style="bottom: 0rem;height: 7rem;">
