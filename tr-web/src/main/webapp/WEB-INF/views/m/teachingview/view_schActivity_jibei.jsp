...
$(document).ready(function(){
	...
	$("#commentBox").attr("src",_WEB_CONTEXT_+"/jy/teachingView/view/comment/list?titleShow=true&authorId=${activity.organizeUserId}&resType=${type}&resId=${activity.id}&title=<ui:sout value='${activity.activityName }' encodingURL='true' escapeXml='true'></ui:sout>&flags=true");
