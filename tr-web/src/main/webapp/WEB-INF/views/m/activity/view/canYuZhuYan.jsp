...
<head>
	...
	<style>
		.partake_discussion_right{width:94%;}
	</style>
</head>
<body>
		...
		<div class="act_info_content">
			<div class="act_info_left">
				...
				<c:if test="${activity.organizeUserId == _CURRENT_USER_.id && activity.spaceId == _CURRENT_SPACE_.id }">
					<input type="button" value="结束活动" class="input" id="overZtyt" activityId="${activity.id }">
				</c:if>
			</div>
								...
								<div id="scroller">
									<div class="">
										<c:forEach items="${usList }" var="user">
											...
											<div class="head" activityId="${activity.id }" userId="${u.id }" canReply="true">
				...
				<div class="content_bottom1_right">
					<div class="content_list">
						...
						<div class="cy_list1 figure_bg">
						  <span class="cy_list"></span><input type="hidden" value="${activity.id }"/>
						  <p>参与讨论</p>
						</div>
