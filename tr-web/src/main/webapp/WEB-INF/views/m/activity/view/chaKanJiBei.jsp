...
<head>
	...
	<meta charset="UTF-8">
	<ui:mHtmlHeader title="同备查看"></ui:mHtmlHeader>
			...
			<div>
				<div class="act_info_content_w">
					...
					<div class="act_modify_btn">
						<input type="button" value="已结束" class="input1" id="yijieshu"/>
					</div>
				</div>
			</div> 
		</div>
...
<div class="partake_discussion_vrap">
	<div class="partake_discussion1" >
		...
		<div class="partake_discussion_content"style="bottom:0;">
			...
			<div class="clear"></div>
			<div id="partake_discussion_content1" class="partake_discussion_content1"  style="height:32rem;"> 
				<!-- 加载讨论内容 -->
		...
		<div class="content">
			<div class="content_bottom1">
				...
				<div class="content_bottom1_center" style=" z-index: 1001;">
					<c:if test="${zhubeiList!=null && fn:length(zhubeiList)>0 }">
					<iframe id="iframe1" editType="0" style="height:100%;" name="iframe1" frameborder="0" scrolling="no" src="${pageContext.request.contextPath }/jy/activity/showLessonPlan?planId=${zhubeiList[0].id }"></iframe>
					</c:if>
				</div>
