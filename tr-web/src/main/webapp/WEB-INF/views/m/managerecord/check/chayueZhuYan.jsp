	...
	<section>
		<div class="content">
			<div class="content_bottom1">
				...
				<div class="content_bottom_center_zt">
					<div class="partake_discussion_content">
						<iframe id="discuss_iframe" style="width: 100%;height: 48rem;border: none;" ></iframe>
						<div class="participants" style="float: right;">
							<h3><span class="participant"></span>参与人<br><q>(点击头像可看全部留言)</q></h3>
							<div class="clear"></div>
			...
			<div class="look_opinion_list">
				...
				<input type="hidden" id="checklistobj" resType="${type}" authorId="${activity.organizeUserId}" resId="${activity.id}" title="<ui:sout value='${activity.activityName }' encodingURL='true' escapeXml='true'></ui:sout>"></div>
				...
				<div class="content_bottom1_right">
					<div class="content_list">
						...
						<div class="ce_list1" data-option="1" resId="${activity.id }" isOver="${activity.isOver }" title="<ui:sout value='${activity.activityName }' encodingURL='true' escapeXml='true'></ui:sout>" authorId="${activity.organizeUserId}">
