		...
		<div class="managerecord_bottom_wrap">
			<div class="managerecord_check">
				<div class="managerecord_check_top">
					<header>
						<ul data-term="${term}" data-grade="${grade}" data-subject="${subject}">
				...
				<div class="managerecord_check_bottom">
					<div id="chart"></div>
					<div id="chart_btn">
						<div><a href="jy/managerecord/check/0">查看详情</a></div>
						<div><a href="jy/managerecord/check/1">查看详情</a></div>
						<div><a href="jy/managerecord/check/2-3">查看详情</a></div>
						<div><a href="jy/managerecord/check/5">查看详情</a></div>
						<div><a href="jy/managerecord/check/8-9">查看详情</a></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript"> 
	require(['zepto','echarts/echarts','check'],function($){	
	});  
</script>
</html>