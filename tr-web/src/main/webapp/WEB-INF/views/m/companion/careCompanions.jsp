...
<head>
	...
	<meta charset="UTF-8">
	<ui:mHtmlHeader title="同伴互助关注同伴"></ui:mHtmlHeader>
...
<form id="companionForm" action="${ctx }/jy/companion/companions/mycomps" method="post">
	<input type="hidden" value="true" name="iscare" >
...
<div class="companion_content_r_l_bottom" id="expmenu_ex" >
	<div id="scroller">
		<ol class="expmenu_ex">
			<li>
				<a class="header"> 
					<span class="arrow up"></span> <span class="label">校内关注同伴<b>${data.sameOrgCount }</b></span>
		     	</a> 
				<span class="no">
					<ol class="menu" style="display: none;">
						<c:forEach items="${data.sameOrg }" var="comp">
							<li class="checkbox_1">
								...
								<div class="split" userid="${u.id }">
									...
									<div class="split_r">
										<h3>${u.name }</h3>
										<span><ui:sout value="${comp.lastMsg }" length="22" needEllipsis="true" ></ui:sout></span>
									</div>
								</div>
							</li>
						</c:forEach>
			...
			<li>
				<a class="header">
					 ...
					 <span class="label">校外关注同伴<b>${data.notSameOrgCount }</b></span>
				</a>
				<span class="no">
					<ol class="menu" style="display: none;">
						<c:forEach items="${data.notSameOrg }" var="comp">
							<li class="checkbox_1">
								<jy:di key="${comp.userIdCompanion }" className="com.tmser.tr.uc.service.UserService" var="u"></jy:di>
								<div class="split" userid="${u.id }">
									<div class="split_l">
