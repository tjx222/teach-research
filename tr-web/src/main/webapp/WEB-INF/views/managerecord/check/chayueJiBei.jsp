...
<iframe id="checkedBox" src="jy/check/infoIndex?flags=false&resType=5&authorId=${activity.organizeUserId}&resId=${activity.id}&titleShow=true" onload="setCwinHeight(this,false,100)" style="border:none;width:1200px;" scrolling="no"></iframe>
 </div>
</div>
</body>
</html>
