...
<div class="jyyl_nav">
		<h3>当前位置：<jy:nav id="cyjl_cyjb"></jy:nav> > 主题研讨</h3>
</div>
...
<iframe id="checkedBox" src="jy/check/infoIndex?flags=false&resType=5&authorId=${activity.organizeUserId}&resId=${activity.id}&titleShow=true" onload="setCwinHeight(this,false,100)" style="border:none;width:100%;" scrolling="no"></iframe>
 </div>
