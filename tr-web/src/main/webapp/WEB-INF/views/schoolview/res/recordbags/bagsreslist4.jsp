				...
				<div class="preparation_resources_2">
							...
							<div class="cont_3_right_cont1_tab_w">
								...
								<div class="c_3_r_c_t_c">
									<h5>
										...
										<span><a href="javascript:" onclick="opearDom(this)" class="user_login" data-url="jy/schoolview/res/recordbags/viewOthers?lesid=${kt.recordId}&recordbagID=${recordbag.id}&teacherId=${cm.teacherId}&gradeId=${cm.gradeId}&subjectId=${cm.subjectId}">${kt.recordName}</a></span>
										<strong>
											<jy:di key="${userID}" className="com.tmser.tr.uc.service.UserService" var="u">
												${u.name}
											</jy:di>
								    ...
								    <h5><b>【<jy:dic key="${kt.crtId}"></jy:dic>】【<jy:dic key="${kt.lastupId}"></jy:dic>】
					...
					<div class="pages">
						...
						<form name="pageForm" method="post">
							<ui:page url="jy/schoolview/res/findresByBagID?orgID=${cm.orgID}&xdid=${cm.xdid}&userID=${userID}&id=${data.datalist[0].bagId}&teacherId=${cm.teacherId}&gradeId=${cm.gradeId}&subjectId=${cm.subjectId}" data="${data}" views="5"/>
