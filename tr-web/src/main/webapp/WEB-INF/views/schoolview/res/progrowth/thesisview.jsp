			...
			<div class="resources_view">
				<div class="resources_view_cont">
					...
					<div class="see_word">
						...
						<iframe id="view" frameborder="0" scrolling="no"
							style="border: none;" src="jy/scanResFile?resId=${thesis.resId}&to=true&orgId=${thesis.orgId}"
				...
				<iframe id="commentBox" onload="setCwinHeight(this,false,600)"
					src="jy/comment/list?authorId=${thesis.crtId}&resType=${resType}&resId=${thesis.id}&title=<ui:sout value='${thesis.thesisTitle}' encodingURL='true' escapeXml='true'></ui:sout>"
