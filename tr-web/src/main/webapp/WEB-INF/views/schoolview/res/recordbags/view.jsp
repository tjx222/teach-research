		...
		<div class="resources_view">
			<div class="resources_view_cont">
				...
				<div class="see_word">
					...
					<iframe id="view" src="jy/scanResFile?resId=${data.resId}&to=true&orgId=${data.orgId}" width="100%" height="700px;" style="border:none;" scrolling="no"></iframe>
				</div>
			</div>
			<div>
			<iframe id="commentBox" onload="setCwinHeight(this,false,600)" src="jy/comment/list?authorId=${data.userId }&resType=${resType}&resId=${recordbagID}&title=<ui:sout value='${data.planName}' encodingURL='true' escapeXml='true'></ui:sout>" width="100%" height="600px;" style="border:none;" scrolling="no"></iframe>
			</div>
		</div>
		<div class="clear"></div>
	</div>
