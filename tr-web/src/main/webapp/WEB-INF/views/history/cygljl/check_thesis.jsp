...
<body style="background: #fff;"> 
	...
	<div class="page_option"> 
		...
		<form id="search_form" action="jy/history/${year}/cygljl/check_thesis" method="post">
			<div class="a">
				...
				<div class="resources_table_wrap_tab down_resource" <c:if test="${checkInfo.flago==1}">style="display:none;"</c:if>>
						...
						<c:if test="${not empty checkInfoList.datalist}">
							<c:forEach items="${checkInfoList.datalist}" var="checkInfo">
								<div class="check_lesson">
									<dl>
										<a href="${ctx}/jy/teachingView/view/thesisview?id=${checkInfo.resId}&showType=manager" target="_blank">
									...
									<div class="operation">
										<div class="download" title="下载" data-id="${resIdsMap[checkInfo.id].resId}"></div>
									</div>
								</div>
							</c:forEach>
						</c:if>
					...
					<div class="">
						<form class="pageForm" name="pageForm" method="post">
							<ui:page url="${ctx}/jy/history/${year}/cygljl/check_thesis" data="${checkInfoList}"  />
				...
				<div class="resources_table_wrap_tab" <c:if test="${checkInfo.flago==0 || checkInfo.flago==null}">style="display:none;"</c:if>>   
					...
					<div class="">
						<form class="pageForm1" name="pageForm1" method="post">
							<ui:page url="${ctx}/jy/history/${year}/cygljl/check_thesis" data="${checkOptionList}"  />
							<input type="hidden" class="currentPage" name="currentPage">
