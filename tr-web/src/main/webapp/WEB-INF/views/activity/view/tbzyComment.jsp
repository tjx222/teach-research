...
<body>
	<div class="view_comments_content" style="top: 0;height: 26rem;width: 35rem;overflow:hidden;">
		<div class="view_comments_content1" id="comment_list"  style="height: 21rem;width: 35rem;">
			<div id="scroller">
				...
				<form  name="pageForm" method="post">
					<ui:page url="${ctx}jy/comment/list?resId=${model.resId }&flags=${model.flags }&resType=${model.resType }&vn=/activity/view/tbzyComment" data="${data}" dataType="true" callback="addmoredatas"/>
...
<!-- 		<div class="left" style="bottom:14rem;"></div> -->
	</div>
