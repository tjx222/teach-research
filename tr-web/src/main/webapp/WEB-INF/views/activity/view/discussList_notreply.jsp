...
<body style="background: none;" >	
	<div class="word_tab_3" style="width:823px;height:auto;">
		...
		<c:if test="${!empty discussList.datalist  }">
			<c:forEach items="${discussList.datalist  }" var="data">
				<div class="check-bottom_1">
					...
					<div style="border-bottom:1px #bdbdbd solid;width:801px;margin-left:15px;margin-top:15px;"></div>
				</div>
				<div class="clear"></div>
			</c:forEach>
