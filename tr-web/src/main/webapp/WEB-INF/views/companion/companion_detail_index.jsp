					...
					<div class="right_option" style="width:9.5%;">
						<div>
							...
							<c:if test="${not empty datas.lecturelist }">
								<a href="javascript:void(0);">
									<span class="right_option_act" style="line-height:1.5rem;height:3.8rem;padding-top:1.2rem;" >听课<br />记录</span>
									<span class="border1"></span>
								</a>
							</c:if>
							<c:if test="${not empty datas.plainlist }">
								<a href="javascript:void(0);">
									<span class="right_option_act" style="line-height:1.5rem;height:3.8rem;padding-top:1.2rem;">计划<br />总结</span>
									<span class="border1"></span>
								</a>
							</c:if>
							<c:if test="${not empty datas.thesislist }">
								<a href="javascript:void(0);">
									<span class="right_option_act" style="line-height:1.5rem;height:3.8rem;padding-top:1.2rem;">教学<br />文章</span>
									<span class="border1"></span>
								</a>
							</c:if>
						</div>
