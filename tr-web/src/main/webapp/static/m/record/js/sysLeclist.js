define(["require","zepto","iscroll","placeholder"], function (require) {
    ...
    function init() { 
    	...
    	jq('.content_bottom_width').on("click",".record_word_2",function (){
    		...
    		jq(".del_width").find("span").html("您确定要删除"+name+"吗？");
    ...
    function deleteIt(one){
    	location.href = _WEB_CONTEXT_ + "/jy/record/delRecords?id="+one+"&bagId="+id+"&type="+type+"&page="+page;
    }
