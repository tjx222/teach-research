	  ...
	  prototype : {
				init: function() {
					...
					if (this.opts.style == 1) {
						...
						if(this.opts.needimage){
							tools = tools.concat('|', 'image');
						}
						tools = tools.concat('|','fullscreen');
				   ...
				   var webOptions =$.extend({}, this.opts,{pasteType:1,newlineTag:'br',minWidth:150,minHeight:60,allowPreviewEmoticons : false,allowImageUpload: true,items : tools});
