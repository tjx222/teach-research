 ...
 *
 * @author wangdawei
 * @version $Id: TeachingViewController.java, v 1.0 2016年4月8日 上午10:42:36 wangdawei Exp $
 */
@Controller
...
public class TeacherViewController extends AbstractController{
	 ...
	 * @author wangdawei
	 */
	@RequestMapping("/teacher/list_listen")
	public String list_listen(SearchVo searchVo, Model m){
		teachingViewService.getListenDataList(searchVo,m);
		return "/teachingview/teacher/list_listen";
	}
	 ...
	 * @author wangdawei
	 */
	@RequestMapping("/teacher/list_summary")
	public String list_summary(SearchVo searchVo, Model m){
		teachingViewService.getSummaryDataList(searchVo,m);
		return "/teachingview/teacher/list_summary";
	}
	 ...
	 * @author wangdawei
	 */
	@RequestMapping("/teacher/list_thesis")
	public String list_thesis(SearchVo searchVo, Model m){
		teachingViewService.getThesisDataList(searchVo,m);
		return "/teachingview/teacher/list_thesis";
	}
	 ...
	 * @author wangdawei
	 */
	@RequestMapping("/teacher/list_schoolActivity")
	public String list_schoolActivity(SearchVo searchVo, Model m){
		teachingViewService.getSchoolActivityDataList(searchVo,m);
		return "/teachingview/teacher/list_schoolActivity";
	}
