 ...
 *
 * @author tmser
 * @version $Id: CheckLessonServiceImpl.java, v 1.0 2015年3月14日 下午4:49:33 tmser Exp $
 */
@Service
@Transactional
public class CheckLessonServiceImpl implements CheckLessonService {
	 ...
	 * @param type
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#listTchLessonStatics(java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Map<Integer, List<Object>> listTchLessonStatics(Integer grade,
			Integer subject, Integer type) {
	 ...
	 * @param bookid
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#listTchLessons(java.lang.Integer, java.lang.String)
	 */
	@Override
	public List<LessonInfo> listTchLessons(Integer type,Integer userId,Integer gradeId,Integer subjectId,Integer searchType,Integer termId, Integer fasciculeId) {
		LessonInfo model = new LessonInfo();
    ...
    private String buildWriteLessonTypeSql(Integer type,String alias){
		...
		switch(type){
			case LessonPlan.JIAO_AN: sql = "and "+as+"jiaoanCount > 0"; break;
			case LessonPlan.KE_JIAN: sql = "and "+as+"kejianCount > 0"; break;
			case LessonPlan.KE_HOU_FAN_SI: sql = "and "+as+"fansiCount > 0";break;
		}
		return sql;
	}
    ...
    private String buildCommitLessonTypeSql(Integer type,String alias){
		...
		switch(type){
			case LessonPlan.JIAO_AN: sql = "and "+as+"jiaoanSubmitCount > 0"; break;
			case LessonPlan.KE_JIAN: sql = "and "+as+"kejianSubmitCount > 0"; break;
			case LessonPlan.KE_HOU_FAN_SI: sql = "and "+as+"fansiSubmitCount > 0";break;
		}
		return sql;
	}
	 ...
	 * @param fasciculeId
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countLessonInfo(java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Integer countLessonInfo(Integer type, Integer userId,Integer gradeId,Integer subjectId,Integer searchType,Integer termId,
			Integer fasciculeId) {
		LessonInfo model = new LessonInfo();
		model.setUserId(userId);
		model.setGradeId(gradeId);
	 ...
	 * @param fasciculeId
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countLessonPlan(java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Integer countLessonPlan(Integer type, Integer userId,Integer gradeId,Integer subjectId,Integer searchType,Integer termId,
	 ...
	 * @param planId
	 * @param m
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#viewLesson(java.lang.Integer, java.lang.Integer, org.springframework.ui.Model)
	 */
	@Override
	 ...
	 * @param bookid
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#listTchLessonsOthers(java.lang.Integer, java.lang.String)
	 */
	@Override
	public List<LessonPlan> listTchLessonsOther(Integer type,Integer userId,Integer gradeId,Integer subjectId,Integer searchType,Integer termId) {
		LessonPlan model = new LessonPlan();
		model.setPlanType(type);
		model.setIsSubmit(true);
		model.setUserId(userId);
	 ...
	 * @param fasciculeId
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countLessonOther(java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	 ...
	 * @param planId
	 * @param m
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#viewOtherLesson(java.lang.Integer, java.lang.Integer, org.springframework.ui.Model)
	 */
	@Override
	 ...
	 * @param fasciculeId
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countCheckLesson(java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Integer countCheckLesson(Integer type, Integer userid,
	 ...
	 * @param fasciculeId
	 * @return
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countSubmitLesson(java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Integer countSubmitLesson(Integer type, Integer userId,
			Integer gradeId, Integer subjectId,Integer searchType,Integer termId, Integer fasciculeId) {
		LessonInfo model = new LessonInfo();
		model.setUserId(userId);
		model.setGradeId(gradeId);
	...
	/** (non-Javadoc)
	 * @see com.tmser.tr.check.cklp.service.CheckLessonService#countCheckLessonPlan(java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Integer countCheckLessonPlan(Integer type, Integer userid,
			Integer gradeId, Integer subjectId, Integer searchType,
		...
		model.setPlanType(type);
		model.addJoin(JOINTYPE.INNER, " CheckInfo c").on(" c.resId = a.infoId and c.gradeId = :gradeId and c.subjectId = :subjectId and c.userId = :userId and c.authorId = :authorId and c.schoolYear = :schoolYear and c.resType = :resType");
		Map<String,Object> paramMap = new HashMap<String,Object>();
