 ...
 *
 * </pre>
 * @version $Id: CheckActivityServiceImpl.java, v 1.0 2015-04-20 Generate Tools Exp $
 */
@Service
@Transactional
public class CheckActivityServiceImpl  implements CheckActivityService {
	 ...
	 * @param page
	 * @return
	 * @see com.tmser.tr.check.activity.service.CheckActivityService#findCheckActivity(java.lang.Integer, java.lang.Integer, com.tmser.tr.common.page.Page)
	 */
	@Override
	public Map<String, Object> findCheckActivity(Integer grade,Integer subject,Integer term, Page page) {
		...
		UserSpace us = (UserSpace)WebThreadLocalUtils.getSessionAttrbitue(SessionKey.CURRENT_SPACE);//用户
		...
		model.setPhaseId(us.getPhaseId());//学段
