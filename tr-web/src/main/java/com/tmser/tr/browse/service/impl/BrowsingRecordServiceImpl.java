...
@Service
@Transactional
public class BrowsingRecordServiceImpl extends AbstractService<BrowsingRecord, Integer>
    implements BrowsingRecordService {
   ...
   * @param type
   * @param resId
   * @see com.tmser.tr.browse.service.BrowsingRecordService#addBrowseRecord(java.lang.Integer,
   *      java.lang.Integer)
   */
  @Override
   ...
   * @param resId
   * @param isShare
   * @see com.tmser.tr.browse.service.BrowsingRecordService#updateBrowseRecordShare(java.lang.Integer,
