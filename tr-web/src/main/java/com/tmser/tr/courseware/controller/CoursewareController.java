...
public class CoursewareController extends AbstractController {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(CoursewareController.class);
	...
	public String preSubmit(@RequestParam(value = "isSubmit") Integer isSubmit,
			Model m) {
		Map<String, Object> submitDatas = coursewareService
	...
	public void submitCoursewareByOne(
			@RequestParam(value = "isSubmit") String isSubmit,
			@RequestParam(value = "planId") Integer planId, Model m) {
		Integer isOk = 0;
		try {
			if ("0".equals(isSubmit)) { // 提交
				myPlanBookService.submitLessonPlansByIdStr(String
						.valueOf(planId));
