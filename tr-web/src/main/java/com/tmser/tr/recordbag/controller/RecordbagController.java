...
public class RecordbagController extends AbstractController{
	...
	public String addRecordBag(@RequestParam(value = "name", required = false) String name,@RequestParam(value = "desc", required = false) String desc,Model m) {
	...
	public String delRecords(@RequestParam(value = "page", required = false) Integer page,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "bagId", required = false) Integer bagId,@RequestParam(value = "type", required = false) Integer type,Model m) {
	...
	public String updateRecordBag(@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "name", required = false) String name,@RequestParam(value = "desc", required = false) String desc,Model m) {
	...
	public String shareRecord(@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,Model m) {
		Recordbag bag = recordbagService.findOne(id);
		bag.setShare(type);
	...
	public String findSysList(LessonPlan plan,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,Model m) {
		Recordbag bag = recordbagService.findOne(id);
		...
		}else 	if(bag.getName().equals(Recordbag.JXWZ)){
			plan.setPlanName(name);
			recordbagService.initThesis(plan, bag, m, id, recordList, type);
			return "record/jxlist";
		}else if(bag.getName().equals(Recordbag.JHZJ)){
			plan.setPlanName(name);
			recordbagService.initPlainSummary(plan, bag, m, id, recordList, type);
			return "record/jxlist";
		}else if(bag.getName().equals(Recordbag.TKJL)){
			plan.setPlanName(name);
			recordbagService.initLecture(plan, bag, m, id, recordList, type);
			return "record/lecturejxlist";
		}
	...
	public String sysList(Record model ,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,Model m) {
		Recordbag bag = recordbagService.findOne(id);
		model.setBagId(id);
		...
		for(Record record : reList.getDatalist()){
			...
			record.setTime(time);
			if(0==Recordbag.switchResType(bag.getName())||1==Recordbag.switchResType(bag.getName())||2==Recordbag.switchResType(bag.getName())){
			...
			if(4==Recordbag.switchResType(bag.getName())){
				recordbagService.saveThesis(record, id);
			}
			if(5==Recordbag.switchResType(bag.getName())){
				recordbagService.savePlainSummary(record, id);
			}
			if(6==Recordbag.switchResType(bag.getName())){
	...
	public String sysJx(@RequestParam(value = "desc", required = false) String desc,@RequestParam(value = "page", required = false) Integer page,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,@RequestParam(value = "one", required = false) Integer one,Model m) {
		Recordbag bag = recordbagService.findOne(id);
		if(bag.getName().equals(Recordbag.JXSJ)||bag.getName().equals(Recordbag.ZZKJ)||bag.getName().equals(Recordbag.JXFS)){
			...
			recordbagService.saveThesis(one, id, type, desc, bag);
		}else if(bag.getName().equals(Recordbag.TKJL)){
			recordbagService.saveLecture(one, id, type, desc, bag);
		}else if(bag.getName().equals(Recordbag.JHZJ)){
			recordbagService.saveSummary(one, id, type, desc, bag);
		}
		//新增内容后更新时间
		m.addAttribute("page.currentPage",page);
		m.addAttribute("id",id);
	...
	public String sysJxUpdate(@RequestParam(value = "desc", required = false) String desc,@RequestParam(value = "page", required = false) Integer page,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,@RequestParam(value = "one", required = false) Integer one,Model m) {
	...
	public String findRList(Record record ,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "type", required = false) Integer type,@RequestParam(value = "page", required = false) Integer p,Model m) {
		Recordbag bag = recordbagService.findOne(id);
	...
	public String updateDesc(@RequestParam("id")Integer id,
			@RequestParam("desc")String desc,
			@RequestParam("page")Integer page, Model m) {
	...
	public String delete(@RequestParam(value = "page", required = false) Integer page,@RequestParam(value = "id", required = false) Integer id,@RequestParam(value = "bagId", required = false) Integer bagId,@RequestParam(value = "type", required = false) Integer type,Model m) {
		recordbagService.deleteBagRecord(id);
		m.addAttribute("page", page);
		m.addAttribute("id",bagId);
		m.addAttribute("type",type);
