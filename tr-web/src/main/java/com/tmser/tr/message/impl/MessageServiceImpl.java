 ...
 *
 * @author tmser
 * @version $Id: MessageServiceImpl.java, v 1.0 May 10, 2015 11:35:26 AM tmser
 *          Exp $
 */
@Service
public class MessageServiceImpl implements MessageService, ApplicationContextAware {
   ...
   * @param messageType
   * @param l
   * @see com.tmser.tr.message.MessageService#addListener(java.lang.Integer,
   *      com.tmser.tr.message.Listener)
   */
  @Override
