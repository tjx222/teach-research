 ...
 */
package com.tmser.tr.myplanbook.service;
...
public interface MyPlanBookService extends BaseService<LessonInfo,Integer>{
	 ...
	 * @return
	 */
	Map<String, Object> getIsOrNotSubmitLessonPlanByBookId(
	 ...
	 * @param m 
	 */
	Model receiveLessonPlanOfSchoolActivity(Integer activityId, Model m) throws FileNotFoundException;

	LessonInfo saveLessonInfo(UserSpace userSpace, String lessonid,
			String lessonName, Integer planType, Book book, Integer schoolYear,
			Integer termId);
