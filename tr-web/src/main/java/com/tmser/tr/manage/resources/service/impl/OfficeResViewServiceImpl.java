...
public class OfficeResViewServiceImpl extends AbstractResViewServiceImpl{
	...
	private String viewName = "/resview/office_res_view";

	private String mediaViewName = "/resview/pageofficeOpenWindow";
	...
	public void doView(Resources res) {
		...
		if("true".equals(to)){
			...
			request.setAttribute("url","/jy/scanResFile?to=true&resId="+res.getId());
		}
    ...
    public String getViewName(Resources res) {
       HttpServletRequest request = WebThreadLocalUtils.getRequest();
	   String to = request.getParameter("to");
       return "true".equals(to) ? viewName : mediaViewName;
    }
