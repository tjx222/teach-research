...
public class JyCompanionController extends AbstractController {
  ...
  public String findCompanions(@ModelAttribute JyCompanionSearchVo vo, Model m,
      @RequestParam(value = "isSearchPage", required = false, defaultValue = "0") Integer isSearchPage) {
    User us = CurrentUserContext.getCurrentUser();
  ...
  public String getAllMessagesIndex(Model m) {
    List<JyCompanionVo> list = jyCompanionService.findLatestConmunicateCompanions();
   ...
   * @return
   */
  private List<JyCompanionVo> getAllCompanions(List<JyCompanionVo> friends, List<JyCompanionVo> list) {
  ...
  public Result addFriend(@PathVariable("userIdCompanion") Integer userIdCompanion) {
    try {
  ...
  public Result removeFriend(@PathVariable("userIdCompanion") Integer userIdCompanion) {
    try {
  ...
  public String getCompaniondetail(@PathVariable("userIdCompanion") Integer userIdCompanion, Model m) {
    JyCompanionVo companionVo = jyCompanionService.findCompanionDetail(userIdCompanion);
